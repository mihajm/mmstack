/**
 * Pure alignment snapping — the Figma/Squarespace snapline behaviour. All
 * coordinates are canvas-space; a zoomed viewport keeps snapping honest by
 * dividing its SCREEN-space threshold by the scale before calling in.
 */
 ...
 * Also the border-attachment helper: candidates can be any set of interesting
 * lines (a container's edges for a CMMN sentry, a port row, a baseline).
 */
